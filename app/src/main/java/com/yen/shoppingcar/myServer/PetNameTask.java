...
import com.yen.shoppingcar.VO.PetNameVO;
...
public class PetNameTask extends AsyncTask<String, Integer, List<PetNameVO>> {
    private static final String TAG = "I am PetNameTask";

    private String url, outStr;

    public PetNameTask(String url, String outStr) {
        this.url = url;
        this.outStr = outStr;
    }

    @Override
    protected List<PetNameVO> doInBackground(String... strings) {
        String urlString = ServerURL.Pet_URL;
