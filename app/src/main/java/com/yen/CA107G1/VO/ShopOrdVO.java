...
public class ShopOrdVO extends ShopItemVO implements java.io.Serializable{
    ...
    public ShopOrdVO(String s_ord_no, Integer s_status_no, String mem_no, Timestamp order_time, Integer s_ord_total, String s_ord_address, Integer s_ord_mem_points) {
